def test_lorum_ipsum_with_moderate_number_of_words():
    ...
    print("test_lorum_ipsum_with_moderate_number_of_words", {'description': 'Test with a moderate number of words', 'input': {'words': 20}, 'expected_result': {'word_count': 20, 'docstring_present': True}})
    ...
    if len(result.split()) == 20 and lorum_ipsum.__doc__ is not None:
        print("PASS")
    else:
        print("FAIL")
